...
@section('content')
    <div id="wrapper">
                            ...
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb p-0 m-0">
                                    <li>
                                        ...
                                        <i class="mdi mdi-arrow-left"></i> Ко всем слайдам
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="col-md-12" id="block_active_image"
                                     @if($page->route_name == 'admin/slides/create')
                                        style="display: none;"
                                     @endif >

                                    <h5 class="text-center text-custom">Активное изображение слайда</h5>
                                    <img @if($page->route_name == 'admin/slides/create') src="" @else src="/assets/images/slides/{{$page->partner->preview_image}}" @endif
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="form_work_on" class="form-horizontal" action="javascript:void(0)">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3"><span class="text-danger">*</span> Ссылка на которую ссылается слайд</label>
                                                <div class="col-md-9">
                                            ...
                                            <div class="form-group text-right m-b-0">
                                                ...
                                                @else
                                                    <button onclick="$('#modal_delete_slide').modal('show');" class="btn  btn-danger btn-lg waves-effect waves-light">
                                                        Удалить
                                                    </button>
        ...
        @include('admin.slides.modal_delete')
...
@section('my_scripts')
    ...
    {!! script_ts('/assets/admin/js/project/slide.js') !!}
@endsection
