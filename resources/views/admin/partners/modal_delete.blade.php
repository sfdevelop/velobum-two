<div id="modal_delete_partner" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            ...
            <div class="panel panel-color panel-danger">
                ...
                <div class="panel-body">
                    <div class="alert alert-icon alert-white alert-danger alert-dismissible fade in" role="alert">
                        ...
                        Вы действительно хотите удалить этого партнера?
                    </div>
                </div>
                <div class="panel-footer text-right">
                    @if($page->route_name == 'admin/partners/update')
                    <a href="{{route('admin/partner/delete', ['id' => $page->item_id])}}" class="btn btn-danger waves-effect waves-light"><i class="dripicons-checkmark"></i> Удалить</a>
                    @else
